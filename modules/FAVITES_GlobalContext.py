...
def tn_favites2gexf(cn,tn):
    ...
    out += '  </meta>\n'
    out += '  <graph defaultedgetype="directed" timeformat="double" timerepresentation="timestamp" mode="dynamic">\n'
    out += '    <attributes class="node" mode="dynamic">\n'
    out += '      <attribute id="infected" title="infected" type="boolean"></attribute>\n'
    out += '    </attributes>\n'
    out += '    <attributes class="edge" mode="dynamic">\n'
    out += '      <attribute id="transmission" title="transmission" type="boolean"></attribute>\n'
    out += '    </attributes>\n'
    ...
    for node in nodes:
        ...
        out += '">\n'
        out += '        <spells>\n'
        out += '          <spell timestamp="0.0"></spell>\n'
        if len(times) != 0 and times[0] != 0: # regular infected nodes
            out += '          <spell timestamp="'
            out += str(times[0])
            out += '"></spell>\n'
        out += '        </spells>\n'
        ...
        if len(times) == 0: # uninfected nodes
            out += '          <attvalue for="infected" value="false" timestamp="0.0"></attvalue>\n'
        elif times[0] == 0: # seed node
            out += '          <attvalue for="infected" value="true" timestamp="0.0"></attvalue>\n'
        else: # regular infected nodes
            out += '          <attvalue for="infected" value="false" timestamp="0.0"></attvalue>\n'
            out += '          <attvalue for="infected" value="true" timestamp="'
            out += str(times[0])
            out += '"></attvalue>\n'
        out += '        </attvalues>\n'
        out += '      </node>\n'
    ...
    for u,v in edges:
        ...
        out += '        </spells>\n'
        out += '        <attvalues>\n'
        out += '          <attvalue for="transmission" value="false" timestamp="0.0"></attvalue>\n'
        for t in times[1:-1]:
            out += '          <attvalue for="transmission" value="true" timestamp="'
            out += str(t)
            out += '"></attvalue>\n'
        out += '        </attvalues>\n'
        out += '      </edge>\n'
